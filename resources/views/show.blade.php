<x-app-layout>
     <div class="container px-4 mx-auto">
          ...
          <div class="flex flex-col pb-12 border-b border-gray-800 lg:flex-row game-details">
               <div class="flex-none bg-gray-800">
                    <img src="{{ $game['coverImageUrl'] }}" alt="cover" />
               </div>

               <div class="lg:ml-12 lg:mr-64">
                    <h2 class="mt-1 text-4xl font-semibold leading-tight lg:mt-0">{{ $game['name'] }}</h2>
                    ...
                    <div class="flex flex-wrap items-center mt-8 space-x-12">
                         ...
                         <div class="flex items-center">
                              <div id="member-rating" class="relative w-16 h-16 bg-gray-800 rounded-full">
                                   @push('js')
                         ...
                         <div class="flex items-center">
                              <div id="critic-rating" class="relative w-16 h-16 bg-gray-800 rounded-full">
                                   @push('js')
                                        @include('partials._rating',[
                                             'slug' => 'critic-rating',
                         ...
                         <!-- Social icons -->
                         @if($game['social'])
                         <div class="flex items-center mt-4 space-x-4 lg:mt-0">
                    ...
                    <div class="mt-12" x-data="{isTrailerModalVisible : false}">
                         <button @click="isTrailerModalVisible = true" target="_blank" class="flex px-4 py-4 space-x-3 font-semibold text-white transition duration-150 ease-in-out bg-blue-500 rounded hover:bg-blue-600">
                         ...
                         <template x-if="isTrailerModalVisible">
                             <x-modal name="isTrailerModalVisible">
                                   <iframe src="{{ $game['trailer'] }}" frameborder="0" width="560" height="315" 
                                   class="absolute top-0 left-0 flex w-full h-full border-0 responsive-iframe" 
          ...
          <div class="container pb-12 mt-8 border-b border-gray-800 images" 
          ...
          >
               ...
               <template x-if="isImageModalVisible">
                    <x-modal name="isImageModalVisible">
            ...
            <div class="container pb-12 mt-8 similar-games-container">
               <h2 class="font-semibold tracking-wide text-blue-500 uppercase">
                    Similar games
               </h2>
